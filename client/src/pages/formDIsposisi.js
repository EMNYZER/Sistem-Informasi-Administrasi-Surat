          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <textarea name="isi_disposisi" value={formData.isi_disposisi} onChange={handleChange} required placeholder="Tindakan/Isi Disposisi" className="mt-1 block w-full rounded-md border border-gray-400 shadow-sm "></textarea>
              </div>
            </div>
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700">Catatan Kepala</label>
              <input type="text" name="catatan" value={formData.catatan} onChange={handleChange} placeholder="Catatan dari kepala (opsional)" className="mt-1 block w-full rounded-md border border-gray-400 shadow-sm " />
            </div>
            <div className="flex justify-end gap-2 mt-6">
              ...
              <button type="submit" className="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded hover:bg-green-700">Simpan Disposisi</button>
            </div>
          </form>
        </div>
      </div>
