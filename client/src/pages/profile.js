                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full text-sm bg-gray-50 border border-gray-200 rounded px-2.5 py-1.5 text-gray-800 focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-transparent pr-10"
                    />
                    <button
                      type="button"
