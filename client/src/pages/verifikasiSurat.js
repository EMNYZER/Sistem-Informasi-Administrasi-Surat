...
function VerifikasiSurat() {
  ...
  const fetchSuratKeluar = async () => {
    try {
      ...
      const response = await axios.get('http://localhost:3001/suratKeluar/status/diajukan', {
        headers: {
  ...
  const handleVerifikasi = async (status) => {
    try {
      ...
      if (status === 'diproses') {
        try {
          await axios.post(`http://localhost:3001/suratKeluar/generate-nomor/${selectedSurat.id_surat}`, {}, {
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-4">
        ...
        <div className="bg-white shadow-sm rounded-lg p-5 mt-2">
          <div className="mb-4">
            <h1 className="text-xl font-semibold text-gray-800">Verifikasi Surat Keluar</h1>
          </div>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="mt-6 flex justify-end gap-2">
                ...
                <button
                  onClick={() => {
                    if (window.confirm('Apakah Anda yakin ingin merevisi surat ini? Pastikan catatan revisi sudah diisi.')) {
                ...
                <button
                  onClick={() => {
                    if (window.confirm('Apakah Anda yakin ingin meneruskan surat ini untuk diproses?')) {
